...
_role1 = "Welcome";
_role1names = ["To OnyX District"];
_role2 = "Developed By";
_role2names = ["Ellis and Josh"];
_role3 = "Visit Our Website at";
_role3names = ["www.onyxdistrict.com"];
_role4 = "Join Our Teamspeak at";
_role4names = ["onyxdistrict.ts3pro.xyz"];
_role5 = "We hope you enjoy your stay!";
