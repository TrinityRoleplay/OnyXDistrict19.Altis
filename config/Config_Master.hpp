...
/* System Settings */
    ...
    escapeMenu_displayText = "OnyX District"; //Text displayed in the escape menu. Make it short.. around 20 characters.
    ...
    vehicle_purchase_multiplier_COP = .05; //Cop Vehicle Buy Price = Config_Vehicle price * multiplier
    ...
    vehicle_cop_impound_multiplier = .5; //TO AVOID EXPLOITS NEVER SET HIGHER THAN A PURCHASE/RENTAL multipler!   Payout = Config_vehicle Price * multiplier
