...
class Clothing {
    ...
    class cop{
        ...
        vests[] = {
            ...
            { "V_TacVest_blk_POLICE", "", 1000, { "life_coplevel", "SCALAR", 3 } },
            { "V_PlateCarrier2_blk", "", 1500, { "life_coplevel", "SCALAR", 5 } }
        };
        backpacks[] = {
            { "NONE", "Remove Backpack", 0, { "", "", -1 } },
    ...
    class gang_2 {
        ...
        uniforms[] = {
            { "NONE", "Remove Uniform", 0, { "", "", -1 } },
            { "C_Driver_1_red_F", "", 5000, { "", "", -1 } }
        };
        headgear[] = {
            { "NONE", "Remove Hat", 0, { "", "", -1 } },
            { "H_HelmetB_Enh_tna_F", "", 5000, { "", "", -1 } }
        };
        goggles[] = {
            { "NONE", "Remove Glasses", 0, { "", "", -1 } },
            { "G_Diving", "", 500, { "", "", -1 } }
        ...
        vests[] = {
            { "NONE", "Remove Vest", 0, { "", "", -1 } },
            { "V_PlateCarrierSpec_blk", "", 30000, { "", "", -1 } }
        };
        backpacks[] = {
            { "NONE", "Remove Backpack", 0, { "", "", -1 } },
            { "B_Carryall_ocamo", "", 5000, { "", "", -1 } },
    ...
    class med_clothing {
        ...
        uniforms[] = {
            { "NONE", "Remove Uniform", 0, { "", "", -1 } },
            { "U_B_CombatUniform_mcam_worn", "EMS Uniform", 50, { "", "", -1 } }
        };
        headgear[] = {
            { "NONE", "Remove Hat", 0, { "", "", -1 } },
            { "H_Cap_blu", "", 10, { "", "", -1 } }
    ...
    class adv_reb {
        title = "STR_Shops_A_Rebel";
        license = "rebel";
        side = "civ";
        uniforms[] = {
            { "NONE", "Remove Uniform", 0, { "", "", -1 } },
            { "U_IG_Guerilla2_1", "", 7000, { "", "", -1 } },
            { "U_OG_Guerilla2_3", "", 6000, { "", "", -1 } },
			{ "U_B_CTRG_1", "", 12000, { "", "", -1 } },
            { "U_B_CTRG_2", "", 12000, { "", "", -1 } },
			{ "U_B_CTRG_3", "", 12000, { "", "", -1 } },
        ...
        vests[] = {
            ...
            { "V_PlateCarrierSpec_mtp", "", 25000, { "", "", -1 } },
            { "V_TacVest_blk", "", 12500, { "", "", -1 } },
            { "V_Chestrig_rgr", "", 12500, { "", "", -1 } },
			{ "V_PlateCarrierIA1_dgtl", "", 12500, { "", "", -1 } },
            { "V_PlateCarrierSpec_rgr", "", 17500, { "", "", -1 } },
            { "V_Chestrig_blk", "", 17500, { "", "", -1 } }
        };
        backpacks[] = {
            { "NONE", "Remove Backpack", 0, { "", "", -1 } },
            { "B_OutdoorPack_blk", "", 500, { "", "", -1 } },
