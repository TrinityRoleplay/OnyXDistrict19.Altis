...
class VirtualShops {
    ...
    class rebel {
        ...
        license = "rebel";
        level[] = { "", "", -1, "" };
        items[] = { "codeCracker","ziptie","waterBottle", "rabbit", "apple", "redgull", "tbacon", "lockpick", "pickaxe", "toolkit", "fuelFull", "peach", "boltcutter", "blastingcharge" };
    };
	
    class gang_1 {
        name = "STR_MAR_Rebel_Market1";
        side = "civ";
        license = "gang_1";
        level[] = { "", "", -1, "" };
        items[] = { "ziptie","waterBottle", "rabbit", "apple", "redgull", "tbacon", "lockpick", "pickaxe", "toolkit", "fuelFull", "peach", "boltcutter", "blastingcharge" };
    };
	
    class adv_rebel {
        name = "STR_Shops_Rebel1";
        side = "civ";
        license = "rebel";
        level[] = { "", "", -1, "" };
        items[] = { "product","ziptie","waterBottle", "rabbit", "apple", "redgull", "tbacon", "lockpick", "pickaxe", "toolkit", "fuelFull", "peach", "boltcutter", "blastingcharge" };
    };
    ...
    class gang {
        ...
        license = "";
        level[] = { "", "", -1, "" };
        items[] = { "codeCracker", "waterBottle", "rabbit", "apple", "redgull", "tbacon", "lockpick", "pickaxe", "toolkit", "fuelFull", "peach", "boltcutter", "blastingcharge" };
    };
    ...
    class drugdealer {
        ...
        license = "";
        level[] = { "", "", -1, "" };
        items[] = { "cocaine_processed", "heroin_processed", "marijuana", "LSDp", "methp" };
    };
...
class VirtualItems {
	...
	class antifreeze {
        variable = "antifreeze";
        displayName = "STR_Item_antifreeze";
        weight = 3;
        buyPrice = 1000;
        sellPrice = -1;
        illegal = false;
